...
function tests() {
  ...
  // Print of the register
  printDay(TEST_REGISTER);

  // Check the lenght of the events
  console.log('Events lenght == 5\t -> \t' + ((TEST_REGISTER.events.length == 5)));

  // Check if 'hamburguesa' is in events
  console.log('Hamburguesa in events\t -> \t' + hasEvent('hamburguesa', TEST_REGISTER.events));

  // Check if 'pizza' is in events
  console.log('Pizza in events \t -> \t' + hasEvent('pizza', TEST_REGISTER.events));
